...
install(FILES ${ARROW_LIBRARY_PATH} DESTINATION ${CMAKE_INSTALL_LIBDIR})
install(DIRECTORY ${ARROW_INCLUDE_DIR} DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})

install(FILES ${ARROW_PARQUET_LIBRARY_PATH} DESTINATION ${CMAKE_INSTALL_LIBDIR})
install(DIRECTORY ${ARROW_INCLUDE_DIR} DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})
