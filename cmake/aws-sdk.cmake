...
set(AWS_LIBRARY_PATH ${install_dir}/lib/libaws-cpp-sdk-core.a)
file(MAKE_DIRECTORY ${AWS_INCLUDE_DIR})
add_library(libaws-cpp-sdk-core STATIC IMPORTED)
...
ExternalProject_Get_Property(libawscpp-download install_dir)
set(AWS_INCLUDE_DIR ${install_dir}/include)
set(AWS_LIBRARY_PATH ${install_dir}/lib/libaws-cpp-sdk-s3.a)
file(MAKE_DIRECTORY ${AWS_INCLUDE_DIR})
add_library(libaws-cpp-sdk-s3 STATIC IMPORTED)
