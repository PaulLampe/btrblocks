...
TEST(ParquetArrowChunkwise, TestNonNullIntegerColumns) {
...
TEST(ParquetArrowChunkwise, TestNonNullDoubleColumns) {
...
TEST(ParquetArrowChunkwise, TestNonNullVarcharColumns) {
